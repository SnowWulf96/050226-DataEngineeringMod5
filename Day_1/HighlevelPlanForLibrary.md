# 050226-DataEngineeringMod5


## AM Tasks:
1. Createa a Github Repo and clone it onto your VMs [x]
2. Create an Architecture Diagram [x]
3. Create User Stories and a delivery plan (scrum or kanban) [x]
...
P.S. You can ask Nirosh for clarification as business stakeholder